 ...
 */
class NombrerController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            return $this->redirect(['view', 'id' => $model->idNombreR]);
        }
    ...
    {
        if (($model = Nombrer::findOne($id)) !== null) {
            return $model;
        }
